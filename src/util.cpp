...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bugo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bugo
    // Mac: ~/Library/Application Support/Bugo
    // Unix: ~/.bugo
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bugo";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "bugo.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "bugod.pid"));
