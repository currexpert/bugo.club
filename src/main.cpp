...
const string strMessageMagic = "Bugo Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
        ...
        nSubsidy = 500 * COIN;			//PoW Block Reward
    }
...
{
    int64_t ret = blockValue * 6/10; //60%
