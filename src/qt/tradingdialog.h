...
private slots:
    ...
    QString BuyBUGO(QString OrderType, double Quantity, double Rate);
    QString SellBUGO(QString OrderType, double Quantity, double Rate);
